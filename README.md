...
## Collection Reports and Media Archive Organization
...
- **dest-collection/**
    - **system/**
        ...
        - **sbfrm_reports/**
          - **game_wihout_box.txt/**: Text file listing the images of the boxarts missing from the collection.

          - **game_wihout_image.txt/**: Text file with the list of the gameplay images missing from the collection.

          - **game_wihout_marquee.txt/**: Text file with the list of the sign images missing from the collection.
          ...
          - **game_wihout_info_name.txt/**: Text file with the list of the games without the name in gamelist.txt.

          - **game_wihout_info_desc.txt/**: Text file with the list of the games without the description in gamelist.txt.

          - **game_wihout_info_genre.txt/**: Text file with the list of the games without the genre of the game in gamelist.txt.
